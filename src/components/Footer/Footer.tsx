      ...
      <Container>
        <div className="footer__content">
          ...
          <div className="footer__links">
            {linksData.map(item => (
              <div key={item.title} className="footer__links-column">
                <p className="footer__links-title">{item.title}</p>
                {item.links.map(elem => (
                  <a href={elem.to} className="footer__links-item" key={elem.name}>{elem.name}</a>
                ))}
              </div>
            ))}
          </div>
